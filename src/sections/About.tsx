      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start mb-20">
          ...
          <div ref={leftRef}>
            ...
            {/* Quick Navigation Links - Stacked */}
            <div className="mt-6 flex flex-col gap-3">
              ...
              <button
                ...
                className="group inline-flex items-center gap-2 text-sm text-gray-500 hover:text-gray-900 transition-colors cursor-pointer"
              >
                <span className="relative flex items-center justify-center w-8 h-8 rounded-full bg-gradient-to-br from-cyan-400 to-blue-500 shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300">
                  <ProjectsIcon className="w-4 h-4 text-white" />
              ...
              <button
                onClick={() => {
                  const section = document.getElementById('analyses');
                  if (section) {
                    const start = window.scrollY;
                    const target = section.getBoundingClientRect().top + window.scrollY;
                    const distance = target - start;
              ...
              >
                ...
                <span className="font-medium">See My Analyses</span>
                <ChevronDown className="w-4 h-4 animate-bounce" />
              </button>
            </div>
          </div>
